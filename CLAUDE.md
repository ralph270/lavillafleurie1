...
- `lacasepitey.html`, `pouyaud.html`, `letripot.html`, `kaiku.html`, `labergerie.html`, `cotemer.html` et `lecharlemagne.html` (+ images Open Graph `*-og.jpg`) — maquettes de prospection pour des restaurants réels (La Case Pitey à La Réunion, La Table du Pouyaud à Périgueux, Le Tripot à Chartres, Le Kaïku à Saint-Jean-de-Luz, La Bergerie à Pralognan-la-Vanoise, Côté Mer à Étretat, Le Charlemagne à Pernand-Vergelesses), sur le même socle technique que `premium.html` avec des effets propres à chacune (fumée en fragment shader, particules qui se métamorphosent en formes, thème clair/sombre au scroll, menu plein écran, aperçu suivant le curseur ; pour Le Charlemagne, un vignoble de la Côte d'Or à l'heure dorée — ciel couchant, rangs de vigne en perspective et colline de Corton en shader, particules qui deviennent grappe, verre de vin puis colline). Elles portent une balise `noindex` et une mention « maquette de démonstration non officielle » dans le footer — préserver ces deux protections.
